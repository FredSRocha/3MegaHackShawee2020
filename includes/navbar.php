...
<li class="nav-item active">
  <a class="nav-link" href="./debtor.php">
  <i class="far fa-handshake"></i>
    <span>Inadimplentes</span></a>
</li>
<hr class="sidebar-divider d-none d-md-block">
<li class="nav-item active">
  <a class="nav-link" href="./capitalization.php">
  <i class="fas fa-copy"></i>
    <span>Títulos Recebíveis</span></a>
</li>
<hr class="sidebar-divider d-none d-md-block">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
               ...
               TERRON
                ...
                <img class="img-profile rounded-circle" src="https://image.prntscr.com/image/yoMrCidwRB_jOsMXXH4RLg.jpg">
              </a>
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="./index-crowdfunding.php">
